...
def get_options(window):
    ...
    image_theme1 = tk.PhotoImage(file="Theme1.png")
    image_theme2 = tk.PhotoImage(file="Theme2.png")
    image_theme3 = tk.PhotoImage(file="Theme3.png")
